...
Compiler optimization is **not a luxury** or a post-v1 effort — it is part of the language contract.
...
- Layout memory better than anyone else
- Continuously improve its machine code output
